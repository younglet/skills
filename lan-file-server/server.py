...
Usage:
    python server.py [directory_to_share]
    If no directory specified, serves current working directory.
"""
import http.server
import os
import sys
...
PORT = 8080
# If an argument is given, use it as the root directory
if len(sys.argv) > 1:
...
def collect_files():
    """Return list of file dicts in ROOT, excluding this script."""
    files = []
    total = 0
